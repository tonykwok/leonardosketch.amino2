 ...
 */
public class Java2DGfx extends AbstractGfx {
    ...
    public Java2DGfx(JFrame frame, Graphics2D g2, JComponent jComponent, BufferedImage img) {
        this.g = g2;
        this.frame = frame;
    ...
    public void setFill(Graphics2D g, Fill fill) {
        ...
        if(fill instanceof com.joshondesign.amino.draw.Color) {
            com.joshondesign.amino.draw.Color c = (com.joshondesign.amino.draw.Color)fill;
    ...
    */
    ...
    private void drawDropShadowShape(com.joshondesign.amino.draw.Shape shape, Graphics2D g) {
    ...
    private java.awt.Color toAwt(com.joshondesign.amino.draw.Color color) {
        return new java.awt.Color((float)color.r,(float)color.g,(float)color.b);
    }
    private java.awt.geom.Point2D toAwt(com.joshondesign.amino.draw.Point pt) {
